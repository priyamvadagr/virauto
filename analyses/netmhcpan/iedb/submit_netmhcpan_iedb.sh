...
#SBATCH --mem=8G
#SBATCH --array=1-85
#SBATCH --output=/ix/djishnu/Priyamvada/virauto/analyses/netmhcpan/iedb/logs/netmhcpan_b1_%A_%a.out
#SBATCH --error=/ix/djishnu/Priyamvada/virauto/analyses/netmhcpan/iedb/logs/netmhcpan_b1_%A_%a.err
...
# Manifest: /ix/djishnu/Priyamvada/virauto/analyses/netmhcpan/iedb/allele_manifest.tsv
############################################################
